...
const CSPage = () => {
  ...
  // Toggle sub-dropdown for an item
  ...
  return (
    <div className="maths-page CS-page">
      <h1>Computer Science Module</h1>
      <p>Welcome to the Computer Science module! Here you'll find all the study materials for each week.</p>
      ...
      <div className="container-layout">
        ...
        <div className="interactive-game-container">
          <h2>🖥️ Quick CS Game!</h2>
          <iframe
            title="CS Game"
            src="https://3072.vercel.app/" /* Replace with a CS-themed interactive if desired */
