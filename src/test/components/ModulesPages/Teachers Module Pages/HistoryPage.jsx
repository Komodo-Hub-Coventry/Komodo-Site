...
const HistoryPage = () => {
  // State for week accordion with dynamic items
  ...
  // Announcements and assignments state
  ...
  // Toggle which week is expanded
  const toggleWeek = (weekKey) => {
    setExpandedWeek(expandedWeek === weekKey ? null : weekKey);
  };

  // Toggle sub-dropdown for an item in a week
  ...
  // Handle new item input changes and addition
  ...
  return (
    <div className="maths-page history-page">
      <h1>History Module</h1>
      <p>Welcome to the History module! Here you'll find all the study materials for each week.</p>
      ...
      <div className="container-layout">
        ...
        <div className="interactive-game-container">
          <h2>🗿 Quick History Quiz!</h2>
          <iframe
            title="History Game"
            src="https://3072.vercel.app/"  /* Replace with a history-themed interactive if desired */
