...
const SciencePage = () => {
  ...
  return (
    <div className="maths-page science-page">
      <h1>Science Module</h1>
      <p>Welcome to the Science module! Here you'll find all the study materials for each week.</p>
      ...
      <div className="container-layout">
        ...
        <div className="interactive-game-container">
          <h2>🔬 Quick Science Quiz!</h2>
          <iframe
            title="Science Game"
            src="https://3072.vercel.app/"  /* Replace with a science-themed interactive if desired */
