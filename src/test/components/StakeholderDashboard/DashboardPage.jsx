...
import SortableWidget from '/src/test/components/StakeholderDashboard/SortableWidget.jsx';
import './DashboardPage.css';
import RevenueChart from '/src/test/components/StakeholderDashboard/RevenueChart.jsx';
import UserTypesPieChart from '/src/test/components/StakeholderDashboard/UserTypesPieChart.jsx';
...
const DashboardPage = () => {
  ...
  return (
    <div className="dashboard">
      <h1 className="header">Stakeholder Dashboard Page</h1>
